<?php /* Smarty version Smarty-3.1.11, created on 2012-10-16 06:13:20
         compiled from "..\smarty\templates\styleAdmin\blueadmin\tinnhanden.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8937507cd032a06062-85449322%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '061ca5c8b24b81a3d26905367900028af44d056d' => 
    array (
      0 => '..\\smarty\\templates\\styleAdmin\\blueadmin\\tinnhanden.tpl',
      1 => 1350367998,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '8937507cd032a06062-85449322',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_507cd0337a4296_73160945',
  'variables' => 
  array (
    'page_title' => 0,
    'name' => 0,
...
<?php if ($_valid && !is_callable('content_507cd0337a4296_73160945')) {function content_507cd0337a4296_73160945($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("headcss.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '8937507cd032a06062-85449322');
content_507cfb00b03209_10606965($_smarty_tpl);
$_smarty_tpl = array_pop($_tpl_stack); /*  End of included template "headcss.tpl" */?>
 
 
            <?php /*  Call merged included template "headjava.tpl" */
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("headjava.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0, '8937507cd032a06062-85449322');
content_507cfb00ea4ea4_17432901($_smarty_tpl);
...
<?php }?></li>
  ...
  <div class="dataTables_wrapper" id="example_wrapper"><div id="example_length" class="dataTables_length"><label>Show <select size="1" name="example_length"><option value="10" selected="selected">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div><div class="dataTables_filter" id="example_filter"><label>Search: <input type="text"></label></div><table class="data display datatable" id="example">
					<thead>
						<tr><th class="sorting_asc" rowspan="1" colspan="1" style="width: 70px; ">Mã tin nhắn</th><th class="sorting" rowspan="1" colspan="1" style="width: 465px; ">Tiêu đề</th><th class="sorting" rowspan="1" colspan="1" style="width: 249px; ">Người gửi</th><th class="sorting" rowspan="1" colspan="1" style="width: 179px; ">Thời gian gửi</th> </tr>
					</thead>
...
?>
             <tr class="gradeA odd">
							...
							<td><a href="xemtinnhan.php?matinnhan=<?php echo $_smarty_tpl->tpl_vars['tin']->value['messageid'];?>
"><?php echo $_smarty_tpl->tpl_vars['tin']->value['title'];?>
</a></td>
 ...
 </html><?php }} ?><?php /* Smarty version Smarty-3.1.11, created on 2012-10-16 06:13:20
         compiled from "..\smarty\templates\styleAdmin\blueadmin\headcss.tpl" */ ?>
<?php if ($_valid && !is_callable('content_507cfb00b03209_10606965')) {function content_507cfb00b03209_10606965($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\wamp\\www\\nhadat\\includes\\smarty\\plugins\\modifier.replace.php';
...
/css/nav.css" media="screen" />
  ...
  <?php }} ?><?php /* Smarty version Smarty-3.1.11, created on 2012-10-16 06:13:20
         compiled from "..\smarty\templates\styleAdmin\blueadmin\headjava.tpl" */ ?>
<?php if ($_valid && !is_callable('content_507cfb00ea4ea4_17432901')) {function content_507cfb00ea4ea4_17432901($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\wamp\\www\\nhadat\\includes\\smarty\\plugins\\modifier.replace.php';
?><!-- BEGIN: load jquery -->
