...
{block name="content"}
 ...
 <div class="box round first grid">
             ...
             <tr class="gradeA odd">
                     <td class="center">{$tinhthanh.ProvinceID}</td>
							
                                  <td ><a href="danhsachquanhuyen.php?districtid={$tinhthanh.ProvinceID}">{$tinhthanh.ProvinceName}</td>
				 <td> <a href="?action=delete&provinceid={$tinhthanh.ProvinceID}"> <button class="btn btn-teal" >Xóa</button> </a>	</td>	
